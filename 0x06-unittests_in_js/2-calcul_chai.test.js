...
describe('calculateNumber', () => {
    ...
    describe('type == "SUM"', () => {
      it('equal positive numbers', () => {
        expect(calculateNumber('SUM', 2.0, 2.0), 4);
      });
  
      it('equal positive numbers (alternate)', () => {
        expect(calculateNumber('SUM', 2.3, 1.8), 4);
      });
      ...
      it('negative and positive numbers', () => {
        expect(calculateNumber('SUM', -2.0, 2.0), 0);
      });
    ...
    describe('type == "SUBTRACT"', () => {
      it('equal positive numbers', () => {
        expect(calculateNumber('SUBTRACT', 2.0, 2.0), 0);
      });
  
      it('equal positive numbers (alternate)', () => {
        expect(calculateNumber('SUBTRACT', 2.3, 1.8), 0);
      });
      ...
      it('negative and positive numbers', () => {
        expect(calculateNumber('SUBTRACT', -2.0, 2.0), -4.0);
      });
    ...
    describe('type == "DIVIDE"', () => {
      ...
      it('equal rounded up numbers', () => {
        expect(calculateNumber('DIVIDE', 2.6, 3.0), 1);
      });
  
      it('equal rounded down numbers', () => {
        expect(calculateNumber('DIVIDE', 2.4, 2.0), 1);
      });
